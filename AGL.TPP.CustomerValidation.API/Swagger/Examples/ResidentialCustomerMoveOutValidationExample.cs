...
{
    public class ResidentialCustomerMoveOutValidationExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var residentialCustomerValidation = new ResidentialCustomerMoveOutValidationModel
            {
