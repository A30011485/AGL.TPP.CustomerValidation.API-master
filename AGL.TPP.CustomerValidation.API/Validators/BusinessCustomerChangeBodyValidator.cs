...
namespace AGL.TPP.CustomerValidation.API.Validators
{
    ...
    /// </summary>
    public class BusinessCustomerChangeBodyValidator : AbstractValidator<BusinessCustomerChangeValidationBodyModel>
    {
        /// <summary>
        /// Builds the business customer validator rules
        /// </summary>
        public BusinessCustomerChangeBodyValidator()
        {
