...
namespace AGL.TPP.CustomerValidation.API.Validators
{
  ...
  /// </summary>
  public class MoveOutCustomerValidationHeaderValidator : AbstractValidator<MoveOutCustomerValidationHeaderModel>
  {
    /// <summary>
    /// Builds validation rules for customer validation header
    /// </summary>
    public MoveOutCustomerValidationHeaderValidator()
    {
