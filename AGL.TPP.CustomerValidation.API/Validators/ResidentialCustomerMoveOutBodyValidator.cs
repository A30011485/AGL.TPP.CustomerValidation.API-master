...
namespace AGL.TPP.CustomerValidation.API.Validators
{
    ...
    /// </summary>
    public class ResidentialCustomerMoveOutBodyValidator : AbstractValidator<ResidentialCustomerMoveOutValidationBodyModel>
    {
        /// <summary>
        /// Builds validation rules for Residential customer body
        /// </summary>
        public ResidentialCustomerMoveOutBodyValidator()
        {
